...
import { GrLinkedin, GrPlayFill } from "react-icons/gr";
...
const TabContentData = ({ item }) => {
  return (
    <div class="accordion-item">
      ...
      >
        <div class="accordion-body">{item.subBody}</div>
      </div>
    </div>
  );
};
      ...
      <div className="about-section-1-wrap">
        <div className="about-section-1">
          <div className="about-sec1-content">
            <h1>About us</h1>
            <p>
              Your stunning website is just a few clicks away. It's easy and
              free
            </p>
      ...
      <div className="about-section-2">
        ...
        <div className="about-sec2-right">
          <p>
            ...
            vitae erat. Nunc ut sem vitae risus tristique posuere.Duis cursus,
          ...
          <Tabs defaultActiveKey={1} id="uncontrolled-tab-example" justify>
            {tabGridData.map((val, index) => (
              <Tab
                ...
                title={val.title}
                key={val.id}
                tabClassName="about-sec3--tab-title"
              >
