    ...
    <div className="container-fluid">
        ...
        <div className="container text-center section_2___grid">
          <div className="card border-0 hover-card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                The craftsmanship given by a professional gives a home its value
                as well as its character. And we aim at providing these skills
                to you.
              </p>
              {/* <a href="/">Read More</a> */}
            </div>
          ...
          <div className="card border-0 hover-card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                The vision of our company is to take the real estate industry in
                the areas that have never been explored before and change the
                overall scenario of real estate sector in the emerging areas.
                The Mission of our company is to help people to create realm of
                their own for a highly satisfying and successful life.{" "}
              </p>
              {/* <a href="/">Read More</a> */}
            </div>
          </div>
          <div className="card border-0 hover-card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                achieve benchmark in quality that touches every walk of life and
                human needs, and to live up to the expectations and discerning
                commitment of quality and customer satisfaction.
              </p>
              {/* <a href="/">Read More</a> */}
            </div>
          </div>
            ...
            <div className="card rounded-0 col-lg">
              ...
              <div className="card-body-cont">
                <div className="card-body hover-card">
                  ...
                  <p className="card-text">
                    With Pioneering innovation in gated communities, we at SURVI
                    Group have been holding an unwavering vision to offer a
                    sustainable balance between affordability and luxury.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="service-section-5">
        <div className="service-sec5-header">
          <h1 className="text-center section_head" style={{ color: "#fff" }}>
            WHY CHOOSING US?
          </h1>
          <div className="underline mt-4">
